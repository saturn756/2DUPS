...
与 docs/interface/04_接口规范.md 和示例测试同步维护。
"""
from .base import (  # noqa: F401
    BBox, CalibrationState, CalibrationStatus, GeometryStatus, Producer, Ref, Status, TrackState,
)
...
from .i6_track_set import Association, Track, TrackSet  # noqa: F401
from .i7_segmentation_map import SegmentationMap  # noqa: F401
from .i8_scene_graph import Edge, Evidence, FrameWindow, Node, SceneGraph2D  # noqa: F401
from .i9_evaluation_record import EvaluationRecord, EvaluationSlice, Failure  # noqa: F401

INTERFACES = ("I1", "I2", "I3", "I4", "I5", "I6", "I7", "I8", "I9")

from .wire import to_wire  # noqa: E402,F401
